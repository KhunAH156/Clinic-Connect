...
public class FitnessHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BreatheBtn.setOnClickListener(v -> startActivity(new Intent(this,BreatheActivity.class)));
        MeditateBtn.setOnClickListener(v -> startActivity(new Intent(this,MeditateActivity.class)));
        StateOfMindBtn.setOnClickListener(v -> startActivity(new Intent(this,StateOfMindActivity.class)));

        Back2clinicBtn.setOnClickListener(v -> startActivity(new Intent(this,StateOfMindActivity.class)));
        //D mer clinic class htae lik tok baw pl
